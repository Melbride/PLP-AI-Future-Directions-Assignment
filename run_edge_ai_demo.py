...
def display_project_summary():
    ...
    components = [
        ...
        ("🏙️  Case Study", "AI-IoT integration for smart cities traffic management"),
        ...
        ("⚕️  Ethics Analysis", "Bias mitigation in personalized medicine AI"),
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("\n⚠️  Demo encountered issues. Please check dependencies.")
